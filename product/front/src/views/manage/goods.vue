<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      ...
      <el-table-column prop="name" label="农产品名称" width="150"></el-table-column>
      ...
      <el-table-column prop="description" label="农产品描述" width="200"></el-table-column>
      <el-table-column prop="no" label="农产品编号"></el-table-column>
