<template>
  <div>
    <div style="width: 100%; height: 100vh; overflow: hidden" class="bgImg login-container">
      <div class="login-page" >

        <div style="width: 260px; margin: 0 auto; padding-top: 15px">
          <div class="item" style="font-size: 30px; color: #67C23A;;font-weight: bold;letter-spacing: 2px;">农产品销售系统</div>
          <div class="item">
          ...
          <div style="padding: 10px 0; text-align: right">
            <span style="cursor: pointer; color: blue" @click="preReset">忘记密码</span>
            <span style="cursor: pointer; color: blue; margin-left: 10px" @click="goRegister">去注册</span>
          </div>
        </div>
      </div>
    </div>
