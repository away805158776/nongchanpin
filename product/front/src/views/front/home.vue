<template>
  <div>
    <div style="margin-top: 10px">
		...
		<el-col :span="6">
		  <el-card>
		    <div style="padding: 10px 0; border-bottom: 2px solid #67C23A; font-size: 20px; color: #67C23A">热销排行榜</div>
		    ...
		    <div style="padding: 10px 0">
		      <el-row v-for="(item, index) in sales" :key="item.id">
		        <div style="padding: 10px 0; cursor: pointer;" @click="goodsDetail(item.id)">
		          ...
		          <el-col :span="12">
		            <div style="overflow: hidden; height: 80px; font-size: 12px;padding-top: 10px;color: #67C23A">
		              &nbsp; &nbsp;{{ item.description }}
		            </div>
		          </el-col>
		        </div>
      ...
      <el-carousel height="250px">
	   ...
	   <el-col :span="18" style="margin-top: 10px;float: right;">
	    <el-card>
	      <el-row :gutter="10">
	        <!--          分类-->
	        <el-col :span="4">
	    ...
	    <el-col :span="18" style="margin-top: 10px;float: right;">
	      <el-card>
	        <div style="padding: 10px 0; border-bottom: 2px solid orangered; font-size: 20px; color: orangered">农产品推荐</div>
	        <div style="padding: 10px 0">
	          <el-row :gutter="10">
