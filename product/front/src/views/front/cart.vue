<template>
  <div style="margin-top: 10px">
    <el-table :data="tableData" stripe style="width: 100%">
      ...
      <el-table-column prop="goods.name" label="农产品名称"></el-table-column>
      <el-table-column prop="goods.realPrice" label="农产品单价"></el-table-column>
      ...
      <el-table-column
          ...
          width="200">
        <template slot-scope="scope">
          <el-button type="danger"  @click="del(scope.row.id)">移除购物车</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <div style="margin-top: 10px">
      <div style="display: flex; background-color: white; padding: 10px">
        <div style="flex: 1; padding-left: 20px; color: #999; font-size: 12px">
          <div>共 <span style="color: red; font-size: 20px">{{ count }}</span> 件农产品</div>
          <div style="color: orange; padding-top: 5px">限时优惠！</div>
        </div>
