        ...
        <el-col :span="16">
          <el-card>
            ...
            <div style="padding: 10px 0">
              <span style="color: #999">限时优惠：</span>
              <span style="margin-left: 20px; color: orangered; font-size: 20px">{{ goods.realPrice }}</span>
              <span style="color: orangered; margin-left: 5px ;font-size: 18px" v-if="goods.discount < 1"> ({{ (goods.discount * 10).toFixed(1) }}折)</span>
            </div>

            <div v-if="goods.discount < 1" style="padding: 10px 0; text-decoration:line-through; color: #999">
              <span>农产品原价：</span>
			  <span style="margin-left: 20px;">{{ goods.price }}</span>
            </div>
            <div style="padding: 10px 0; color: #999">

			  <span>农产品库存：</span>
			  <span style="margin-left: 20px;">{{ goods.store }}</span>
            </div>

            <div style="padding: 10px 0; color: #999;">
              <span>农产品服务：</span>
              <span style="color: #666;margin-left:20px">包邮、七天无理由</span>
            </div>
            ...
            <div style="margin-top: 20px; padding: 10px 0">
              ...
              <el-button style="margin-left: 10px; background-color: #409EFF; color: white; position: relative"
                         @click="addCart">
                <img :src="cartIcon" style="width: 20px; position: absolute; left: 8px; top: 5px">
                <span style="margin-left: 20px">加入购物车</span>
              </el-button>
              <el-button style="margin-left: 10px; background-color: #67C23A; color: white" @click="buyNow">立即购买
              </el-button>
            </div>
