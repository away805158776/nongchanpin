<template>
  <div>
    ...
    <div style="width: 100%; height: 60px; line-height: 60px; background-color: white">
      <el-row>
        <el-col :span="4">
          <div style="font-size: 20px; font-weight: bold; text-align: right;margin-right: 50px;"><a style="color: #67C23A;" href="/front/home">农产品销售系统</a></div>
        </el-col>
        <el-col :span="10">
        ...
        <el-col :span="6">
          <div v-if="!$route.path.includes('/search')">
            <el-input style="width: 80%" placeholder="请输入农产品名称搜索农产品" v-model="searchText"></el-input>
...
<!--        Subject: <span style="">再小的帆也能远航！</span>-->
<!--      </div>-->
      <div style="text-align: center; padding: 5px 0; font-size: 12px; color: gray">
        © 2025 农产品销售系统 | 产地直供 · 新鲜到家
      </div>
    </div>
